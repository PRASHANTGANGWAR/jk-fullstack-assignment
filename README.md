...
```
cd existing_repo
git remote add origin https://gitlab.com/assignments9642411/blog-app.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/assignments9642411/blog-app/-/settings/integrations)
